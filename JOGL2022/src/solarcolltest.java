...
public class solarcolltest extends JOGL1_3_VertexArray {
	...
	public solarcolltest() { // it runs always for inheritance, so it is better to inialize in init()
	}
...
//		gl.glBufferData(GL_ARRAY_BUFFER, vBuf.limit() * Float.BYTES, vBuf, GL_STATIC_DRAW);
	...
	public static void main(String[] args) {
		solarcolltest f = new solarcolltest();
